#!/usr/bin/env bash
# ==============================================================================
# P5: Controlled Reclaim Interference Stress Test Runner
...
SUMMARY_CSV="${BASE_DIR}/results/summary/p5_summary.csv"

CONFIGS=(
    "p5_compaction_high_heat.ini"
    "p5_compaction_low_heat.ini"
    "p5_compaction_control_none.ini"
)

echo "=== P5 Controlled Reclaim Interference Plan ==="
...
for cfg_name in "${CONFIGS[@]}"; do
    ...
    for rep in 1 2 3; do
        ...
        echo "--------------------------------------------------------"
        echo "[P5 Run] Config: ${cfg_name}, Repetition: ${rep}/3, ID: ${run_id}"
