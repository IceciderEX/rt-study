#!/usr/bin/env python3
"""
Aggregates E3 results into statistical summary tables (mean, std, min, max).
"""
import os
import pandas as pd
import numpy as np
...
OUT_TABLE_CSV = os.path.join(SUMMARY_DIR, "e3_aggregated.csv")
...
def aggregate():
    ...
    print(f"E3 aggregated summary saved to: {OUT_TABLE_CSV}")
