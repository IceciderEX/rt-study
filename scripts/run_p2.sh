#!/usr/bin/env bash
# ==============================================================================
# P2: Range Tombstone Organization Patterns Runner
...
SUMMARY_CSV="${BASE_DIR}/results/summary/p2_summary.csv"

CONFIGS=(
    "p2_tombstone_short_fragmented.ini"
    "p2_tombstone_long_contiguous.ini"
    "p2_tombstone_short_overlapped.ini"
    "p2_tombstone_long_overlapped.ini"
)

echo "=== P2 Range Tombstone Organization Plan ==="
...
for cfg_name in "${CONFIGS[@]}"; do
    ...
    for rep in 1 2 3; do
        ...
        echo "--------------------------------------------------------"
        echo "[P2 Run] Config: ${cfg_name}, Repetition: ${rep}/3, ID: ${run_id}"
