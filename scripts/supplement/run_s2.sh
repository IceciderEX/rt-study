#!/usr/bin/env bash
# ==============================================================================
# S2: Fair Tombstone Fragmentation Runner (18 runs)
...
echo "=== S2 Fair Tombstone Fragmentation Suite ==="
...
for cfg_name in "${CONFIGS[@]}"; do
    ...
    for rep in 1 2 3; do
        ...
        echo "--------------------------------------------------------"
        echo "[S2 Run] Config: ${cfg_name}, Repetition: ${rep}/3, ID: ${run_id}"
