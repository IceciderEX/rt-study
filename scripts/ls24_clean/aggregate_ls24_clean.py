...
def main():
    src_csv = "/home/wam/grad/s14-range-delete-study/results/summary/ls24_clean_all_runs.csv"
    prog_csv = "/home/wam/grad/s14-range-delete-study/results/summary/ls24_clean_timeseries_progress.csv"
    out_csv = "/home/wam/grad/s14-range-delete-study/results/summary/ls24-clean.csv"
    phases_csv = "/home/wam/grad/s14-range-delete-study/results/summary/ls24-clean-phases-breakdown.csv"
    ...
    out_row = {
        'benchmark': 'LS24-Clean (No DeleteRange)',
        'runs_count': len(rows),
    ...
    print(f"Saved LS24-Clean summary to {out_csv}")
    ...
    if os.path.exists(prog_csv):
        ...
        print(f"Saved LS24-Clean phase breakdown to {phases_csv}")
