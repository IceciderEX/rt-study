#!/usr/bin/env python3
"""
Aggregates E2 results into statistical summary tables (mean, std, min, max).
"""
import os
import pandas as pd
import numpy as np
...
OUT_TABLE_CSV = os.path.join(SUMMARY_DIR, "e2_aggregated.csv")
...
def aggregate():
    ...
    print(f"E2 aggregated summary saved to: {OUT_TABLE_CSV}")
