#!/usr/bin/env python3
"""
Aggregates P6 results into statistical summary tables (mean, std, min, max).
"""
import os
import pandas as pd
import numpy as np
...
OUT_TABLE_CSV = os.path.join(SUMMARY_DIR, "p6_aggregated.csv")
...
def aggregate():
    ...
    print(f"P6 aggregated summary saved to: {OUT_TABLE_CSV}")
