#!/usr/bin/env bash
# ==============================================================================
# P4: Deletion Interval Locality (Cold / Medium / Hot) Runner
...
SUMMARY_CSV="${BASE_DIR}/results/summary/p4_summary.csv"

CONFIGS=(
    "p4_locality_cold.ini"
    "p4_locality_medium.ini"
    "p4_locality_hot.ini"
)

echo "=== P4 Deletion Interval Hotspot Locality Plan ==="
...
for cfg_name in "${CONFIGS[@]}"; do
    ...
    for rep in 1 2 3; do
        ...
        echo "--------------------------------------------------------"
        echo "[P4 Run] Config: ${cfg_name}, Repetition: ${rep}/3, ID: ${run_id}"
