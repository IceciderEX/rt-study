#!/usr/bin/env python3
"""
Aggregates E1 results into statistical summary tables.
"""
import os
import pandas as pd
import numpy as np
...
OUT_TABLE_CSV = os.path.join(SUMMARY_DIR, "e1_aggregated.csv")
...
def aggregate():
    ...
    print(f"E1 aggregated summary saved to: {OUT_TABLE_CSV}")
